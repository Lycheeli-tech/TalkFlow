...
from app.api.v1 import about_me, course_answers, courses, health, practice_v2
...
api_router.include_router(practice_v2.router, prefix="/practice", tags=["practice-v2"])
